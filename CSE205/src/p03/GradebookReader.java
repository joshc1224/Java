...
public class GradebookReader  {
     ...
     */
    public GradebookReader(String pFname) throws FileNotFoundException/*, NoSuchElementException*/ {
        mIn = new Scanner(new File(pFname));
    }

    /**
     * Reads the exam scores for a Student.
     * throws NoSuchElementException if lines are not in correct format
     */
    private void readExam(Student pStudent) /*throws NoSuchElementException*/ {						//Exception used here to ensure appropriate number of scores are entered
     ...
     * throws NoSuchElementException if lines are not in correct format
     */
    public Roster readGradebook() /*throws NoSuchElementException*/ {
     ...
     * throws NoSuchElementException if lines are not in correct format
     */
    private Roster readRoster() /*throws NoSuchElementException*/ {
