...
public class MergeSorter {
	...
	private int lCount=0, rCount=0, mergeCount=0;
    /**
     ...
     */
    public void mergeSort(ArrayList<Integer> pList) {
        ...
        mergeSort(listL);
        System.out.println("made Leftb"+" "+lCount);
		lCount++;
        mergeSort(listR);
        System.out.println("Made Rightb"+" "+rCount);
		rCount++;
        ...
        System.out.println("Merged Listsb"+" "+mergeCount);
		mergeCount++;
    }
